...
<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        if(empty($error))
        {
            ...
            if($id_insert ==NULL or $count_insert ==NULL)
            {  
            ...
            {
                $_SESSION['error']="Thêm mới thất bại, kt lại email";
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row" >
                                        ...
                                        <div class="col-sm-3" style="padding-left:1cm;">
                                            <input type="text" class="form-control" id=" " placeholder="0123456789" name="phone" value="0">
